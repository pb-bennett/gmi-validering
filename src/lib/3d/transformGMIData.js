  ...
  lines.forEach((line, lineIndex) => {
    ...
    for (let i = 0; i < line.coordinates.length - 1; i++) {
      ...
      pipes.push({
        ...
        _layerHiddenCodes: line._layerHiddenCodes || [],
        _layerHiddenTypes: line._layerHiddenTypes || [],
        _layerFeltHiddenValues: line._layerFeltHiddenValues || [],
  ...
  points.forEach((point, pointIndex) => {
    ...
    if (fcode === 'LOK') {
      ...
      loks.push({
        ...
        _layerHiddenCodes: point._layerHiddenCodes || [],
        _layerHiddenTypes: point._layerHiddenTypes || [],
        _layerFeltHiddenValues: point._layerFeltHiddenValues || [],
