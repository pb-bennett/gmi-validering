...
export const RuleReasonCode = Object.freeze({
  ...
  UNUSUAL_VALID_VALUE: 'UNUSUAL_VALID_VALUE',
  NUMERIC_ZERO: 'NUMERIC_ZERO',
  NUMERIC_OUTSIDE_PREFERRED_RANGE: 'NUMERIC_OUTSIDE_PREFERRED_RANGE',
  NUMERIC_OUTSIDE_ALLOWED_RANGE: 'NUMERIC_OUTSIDE_ALLOWED_RANGE',
  TEMA_INVALID: 'TEMA_INVALID',
  TEMA_MISSING: 'TEMA_MISSING',
  SCHEMA_TEMA_SFCODE_COEXISTENCE: 'SCHEMA_TEMA_SFCODE_COEXISTENCE',
  DEPENDENT_TEMA_UNRESOLVED: 'DEPENDENT_TEMA_UNRESOLVED',
  ...
  NUMERIC_PRECISION_UNAVAILABLE: 'NUMERIC_PRECISION_UNAVAILABLE',
  VALUE_NOT_DECIMAL: 'VALUE_NOT_DECIMAL',
  DECIMAL_NOTATION_UNRESOLVED: 'DECIMAL_NOTATION_UNRESOLVED',
  YEAR_FORMAT_INVALID: 'YEAR_FORMAT_INVALID',
  DATE_FORMAT_INVALID: 'DATE_FORMAT_INVALID',
  LEXICAL_FORMAT_UNAVAILABLE: 'LEXICAL_FORMAT_UNAVAILABLE',
  ...
  APPLICABILITY_REQUIRED_MISSING: 'APPLICABILITY_REQUIRED_MISSING',
  APPLICABILITY_UNEXPECTED_VALUE: 'APPLICABILITY_UNEXPECTED_VALUE',
  YEAR_FUTURE: 'YEAR_FUTURE',
  YEAR_PLAUSIBILITY: 'YEAR_PLAUSIBILITY',
  DATE_FUTURE: 'DATE_FUTURE',
  DATE_BEFORE_INSTALLATION: 'DATE_BEFORE_INSTALLATION',
  DATE_OLDER_THAN_FIVE_YEARS: 'DATE_OLDER_THAN_FIVE_YEARS',
  POSITIONING_CAUSE_SHARED_NYTT_YEAR: 'POSITIONING_CAUSE_SHARED_NYTT_YEAR',
  EXISTING_INFRASTRUCTURE_VALUE_MISSING: 'EXISTING_INFRASTRUCTURE_VALUE_MISSING',
});
 ...
 * @property {'REQUIRED'|'ALLOWED_VALUE'|'REQUIRED_ALLOWED_VALUE'|'INTEGER_FORMAT'|'FIELD_RELATIONSHIP'} evaluatorKind
 * @property {'REQUIRED_FIELD'|'ALLOWED_VALUE'|'REQUIRED_ALLOWED_VALUE'|'VALUE_FORMAT'|'FIELD_COMPATIBILITY'} category
