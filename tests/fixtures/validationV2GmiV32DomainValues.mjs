// Independent v3.2 Appendix A rebaseline fixtures. Keep these separate from
// executable registry constants so list-contract tests retain an oracle.
export const EXPECTED_MATERIAL_VALUES = [
...
export const EXPECTED_POINT_TEMA_VALUES = [
...
export const EXPECTED_LINE_TEMA_VALUES = [
...
export const EXPECTED_TYPE_VALUES = [
